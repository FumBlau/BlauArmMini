...
void loop() {
  delay(10); // Delay function to slow movement of arm down
//  if (mode == LOW){


//Serial.println(INITANGLE[0]);
//Serial.println(INITANGLE[1]);
//Serial.println(INITANGLE[2]);
//Serial.println(INITANGLE[3]);
